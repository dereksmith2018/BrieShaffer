<template>
  <Layout>
    ...
    <ul>
      <li>
        <g-link to="/media-images/media-images-one">Image One</g-link>
      </li>
      <li>
        <g-link to="/media-images/media-images-two">Image Two</g-link>
      </li>
      <li>
        <g-link to="/media-images/media-images-three">Image Three</g-link>
      </li>
    </ul>
